...
public class AccessTest {
	...
	public void testVariableAccessInNoClasspath() throws Exception {
		...
		assertEquals("new PropPanelButton(org.argouml.uml.ui.behavior.use_cases.PropPanelUseCase.this , buttonPanel , _navUpIcon , org.argouml.i18n.Translator.localize(\"UMLMenu\", \"button.go-up\") , \"navigateNamespace\" , null)", elements.get(2).getParent().toString());
	}
}
