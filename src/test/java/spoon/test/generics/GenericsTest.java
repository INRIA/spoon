...
public class GenericsTest {
	...
	public void testAccessToGenerics() throws Exception {
		...
		final CtNewClass<?> anonymousBar = foo.getElements(new AbstractFilter<CtNewClass<?>>(CtNewClass.class) {
			@Override
		...
		// For JDT, the type of an anonymous class is its super class.
		final List<CtTypeReference<?>> newClassBarGenerics = anonymousBar.getAnonymousClass().getSuperclass().getActualTypeArguments();
