...
public class GenericsTest {
	...
	public void testModelBuildingTree() throws Exception {
		...
		assertEquals(
				...
				node5.getBody().getIthStatement(0).toString());
	}
	...
	public void testDiamond2() throws Exception {
		...
		CtLocalVariable<?> var = c.getBody().getIthStatement(1);
	...
	public void testInstanceOfMapEntryGeneric() throws Exception {
		...
		CtBinaryOperator<?> instOf = (CtBinaryOperator<?>) ((CtLocalVariable<?>) meth.getBody().getIthStatement(0)).getDefaultExpression();
	...
	public void testConstructorCallGenerics() throws Exception {
		...
		final CtElement local1 = m.getBody().getIthStatement(0).getElements(new TypeFilter<>(CtLocalVariable.class)).get(0);
		...
		final CtElement local2 = m.getBody().getIthStatement(1).getElements(new TypeFilter<>(CtLocalVariable.class)).get(0);
		...
		final CtElement local3 = m.getBody().getIthStatement(2).getElements(new TypeFilter<>(CtLocalVariable.class)).get(0);
		...
		final CtElement local4 = m.getBody().getIthStatement(3).getElements(new TypeFilter<>(CtLocalVariable.class)).get(0);
		...
		final CtConstructorCall constructorCall1 = (CtConstructorCall) m.getBody().getIthStatement(4).getElements(new TypeFilter<>(CtConstructorCall.class)).get(0);
		...
		final CtConstructorCall constructorCall2 = (CtConstructorCall) m.getBody().getIthStatement(5).getElements(new TypeFilter<>(CtConstructorCall.class)).get(0);
	...
	public void testInvocationGenerics() throws Exception {
		...
		final CtInvocation<?> explicitConstructorCall = (CtInvocation<?>) defaultConstructor.getBody().getIthStatement(0).getElements(new TypeFilter<>(CtInvocation.class)).get(0);
		...
		final CtInvocation invocation1 = m.getBody().getIthStatement(0).getElements(new TypeFilter<>(CtInvocation.class)).get(0);
		...
		final CtInvocation invocation2 = m.getBody().getIthStatement(1).getElements(new TypeFilter<>(CtInvocation.class)).get(0);
	...
	public void testNewClassGenerics() throws Exception {
		...
		final CtNewClass newClass1 = m.getBody().getIthStatement(0).getElements(new TypeFilter<>(CtNewClass.class)).get(0);
		...
		final CtNewClass newClass2 = m.getBody().getIthStatement(1).getElements(new TypeFilter<>(CtNewClass.class)).get(0);
	...
	public void testName() throws Exception {
		...
		final CtConstructorCall constructorCall1 = m.getBody().getIthStatement(0).getElements(new TypeFilter<>(CtConstructorCall.class)).get(0);
