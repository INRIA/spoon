...
public class GenericsTest {
	...
	public void testConstructorCallGenerics() throws Exception {
		...
		final CtTypeReference<Object> leftSideLocal1 = (CtTypeReference<Object>) local1.getElements(new TypeFilter<>(CtTypeReference.class)).get(0);
		...
		final CtTypeReference<Object> leftSideLocal2 = (CtTypeReference<Object>) local2.getElements(new TypeFilter<>(CtTypeReference.class)).get(0);
		...
		final CtTypeReference<Object> leftSideLocal3 = (CtTypeReference<Object>) local3.getElements(new TypeFilter<>(CtTypeReference.class)).get(0);
		...
		final CtTypeReference<Object> leftSideLocal4 = (CtTypeReference<Object>) local4.getElements(new TypeFilter<>(CtTypeReference.class)).get(0);
