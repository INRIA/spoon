...
public class ParameterTest {
	...
	public void testGetParameterReferenceInLambdaNoClasspath() throws Exception {
		...
		CtParameter ctParameter = ctMethod.getBody().getIthStatement(0).getElements(new TypeFilter<CtParameter>(CtParameter.class) {
			@Override
		...
		List<CtParameterReference> elements = ctMethod.getBody().getIthStatement(0).getElements(new TypeFilter<CtParameterReference>(CtParameterReference.class) {
			@Override
