...
//
///**
// * Clones provided AST and substitutes required nodes and attributes using
// * defined parameters
// */
...
//	/*
//	 * Set of parents of substituted elements, which might be potentially simplified
//	 * (partially evaluated)
//	 */
...
//
//	/**
//	 * Handle substitution of single value element. Zero or one element can be
//	 * result of substitution of `element`
//	 */
//	@Override
...
//			return null;
//		}
//		// TODO refactor clone process by way it directly delivers correct CtRole. Next
//		// line has some performance impact
...
//
//	/**
//	 * Handle substitution of element in a collection. Zero, one or more elements
//	 * can be result of substitution of `element`
//	 */
//	@Override
...
//
//	/**
//	 * Handle substitution of element in a Map. Zero or one element can be result of
//	 * substitution of `element`
//	 */
//	@Override
...
//			// TODO it would be nice if CloneHelper would directly set the required class,
//			// but it would need more changes...
...
//						origin.getFactory().getEnvironment()
...
//
//	/**
//	 * Clones or substitutes origin element using {@link Node} of the role of this
//	 * attribute for `origin` element, then element is substituted
//	 * 
//	 * @param origin
//	 *            to be cloned or substituted element
//	 * @param result
//	 *            holder for result
//	 */
...
//					// TODO - this is just dirty workaround, which removes imports for templates too
//					// - but it should be no big problem ...
...
//
//	/**
//	 * plans simplification of clone of `element` after cloning of it's children is
//	 * finished
//	 * 
//	 * @param element
//	 *            origin (not cloned) element, whose clone has to be simplified
//	 */
