...
public class CtBiScannerDefault extends spoon.reflect.visitor.CtAbstractBiScanner {
	...
	public void visitCtReceiverParameter(spoon.reflect.declaration.CtReceiverParameter receiverParameter) {
		spoon.reflect.declaration.CtReceiverParameter other = ((spoon.reflect.declaration.CtReceiverParameter) (this.stack.peek()));
		enter(receiverParameter);
		biScan(spoon.reflect.path.CtRole.ANNOTATION, receiverParameter.getAnnotations(), other.getAnnotations());
		biScan(spoon.reflect.path.CtRole.TYPE, receiverParameter.getType(), other.getType());
		biScan(spoon.reflect.path.CtRole.COMMENT, receiverParameter.getComments(), other.getComments());
	...
	public void visitCtRecordPattern(spoon.reflect.code.CtRecordPattern recordPattern) {
		spoon.reflect.code.CtRecordPattern other = ((spoon.reflect.code.CtRecordPattern) (this.stack.peek()));
		enter(recordPattern);
		biScan(spoon.reflect.path.CtRole.TYPE_REF, recordPattern.getRecordType(), other.getRecordType());
		biScan(spoon.reflect.path.CtRole.PATTERN, recordPattern.getPatternList(), other.getPatternList());
		biScan(spoon.reflect.path.CtRole.ANNOTATION, recordPattern.getAnnotations(), other.getAnnotations());
		biScan(spoon.reflect.path.CtRole.TYPE, recordPattern.getType(), other.getType());
