...
class ModelRoleHandlers {
	...
	static class CtTypePattern_PATTERN_RoleHandler extends SingleHandler<CtTypePattern, CtLocalVariable<? extends Object>> {
		private CtTypePattern_PATTERN_RoleHandler() {
