...
class ModelRoleHandlers {
	...
	static class CtSealable_TYPE_REF_RoleHandler extends SetHandler<CtSealable, CtTypeReference<?>> {
		private CtSealable_TYPE_REF_RoleHandler() {
			super(CtRole.TYPE_REF, CtSealable.class, CtTypeReference.class);
		}
