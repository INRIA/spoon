...
class ModelRoleHandlers {
	...
	static class CtBreak_EXPRESSION_RoleHandler extends SingleHandler<CtBreak, CtExpression<? extends Object>> {
		private CtBreak_EXPRESSION_RoleHandler() {
			super(CtRole.EXPRESSION, CtBreak.class, CtExpression.class);
		}
