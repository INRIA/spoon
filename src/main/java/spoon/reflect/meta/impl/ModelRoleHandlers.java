...
class ModelRoleHandlers {
	...
	static class CtArrayTypeReference_ARRAY_DECLARATION_KIND_RoleHandler extends SingleHandler<CtArrayTypeReference, ArrayDeclarationKind> {
		private CtArrayTypeReference_ARRAY_DECLARATION_KIND_RoleHandler() {
			super(CtRole.ARRAY_DECLARATION_KIND, CtArrayTypeReference.class, ArrayDeclarationKind.class);
		}

		@SuppressWarnings("unchecked")
		@Override
		public <T, U> U getValue(T element) {
			return ((U) ((Object) (castTarget(element).getDeclarationKind())));
		}

		@Override
		public <T, U> void setValue(T element, U value) {
			castTarget(element).setDeclarationKind(castValue(value));
		}
	}
