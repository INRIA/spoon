...
public interface IModelBuilder<T> {
   ...
   */
  public abstract void insertInputPath(String identifier, String path);
    ...
    */
  public abstract void insertInputPath(String identifier, T model);
   /**
    ...
    */ 
  public abstract T getModelWithIdentifier(String identifier);
}
