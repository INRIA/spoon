...
public class Statement extends CodeElementPredicate {
    public Statement(CtElement codeElement) { super(codeElement); }
     ...
     */
    public Statement(CtElement codeElement, Map<String, MetavariableConstraint> metavars) { super(codeElement, metavars); }
